...
void View::resize(int w, int h)
{
    ...
    proj = glm::ortho(0.0f,1.0f*WINDOW_WIDTH,0.0f,1.0f*WINDOW_HEIGHT);
...
void View::draw()
{
     ...
     */
   // glm::mat4 triangleTransform = glm::scale(glm::mat4(1.0),glm::vec3(20,100,20));
	

	modelView.push(glm::mat4(1.0)); //modelview is identity
	...
	modelView.top() = modelView.top() 
					*  glm::translate(glm::mat4(1.0),glm::vec3(0.5f*WINDOW_WIDTH,0.5f*WINDOW_HEIGHT,0.0f)); //move center of amusement ride
	...
	for (int j=0;j<NUMSTATIONS;j++)
	{
		...
		modelView.top() = modelView.top()
					* glm::rotate(glm::mat4(1.0),2*time,glm::vec3(0,0,1)) //put at correct starting point in orbit
					* glm::rotate(glm::mat4(1.0),j*2*PI/NUMSTATIONS,glm::vec3(0,0,1)) //put at correct starting point in orbit
					* glm::translate(glm::mat4(1.0),glm::vec3(0.2*WINDOW_WIDTH,0,0)) //put it in orbit
					* glm::rotate(glm::mat4(1.0),sign * 3*time,glm::vec3(0,0,1)); //rotate the fan with center at origin	
		for (int i=0;i<NUMBLADES;i++)
		{
			
			modelView.push(modelView.top());
			modelView.top() = modelView.top()
						* glm::rotate(glm::mat4(1.0),i*2*PI/NUMBLADES,glm::vec3(0,0,1))
						* glm::scale(glm::mat4(1.0),glm::vec3(20,100,1))
						* glm::translate(glm::mat4(1.0),glm::vec3(0,-1,0)); //per blade transform
